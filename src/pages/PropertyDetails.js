      ...
      <div className="container mx-auto min-h-[800px] mb-14">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h3 className="text-lg text-gray-500 mb-4 mt-4 lg:mt-0">{house.address}</h3>
          </div>
        ...
        <div className="flex flex-col items-start gap-8 lg:flex-row">
          ...
          <div className="flex-1 bg-gray-50 w-full mb-8 border border-gray-200 rounded-lg px-6 py-8">
            ...
            <form className="flex flex-col gap-y-4">
              ...
              />
              <textarea
                className="border border-gray-200 focus:border-purple-700 outline-none resize-none rounded w-full p-4 h-36 text-sm text-gray-400"
                placeholder="Message*"
